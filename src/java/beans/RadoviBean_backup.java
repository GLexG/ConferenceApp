...
@ManagedBean
@ViewScoped
public class RadoviBean_backup {
    ...
    public RadoviBean_backup(){}
     
    public RadoviBean_backup(List<Rad> mojiRadovi, List<Korisnik> autori, int glavniAutorID) {
