...
@ManagedBean
@ViewScoped
public class PretragaRadovaBean {
    ...
    //public List<Rad> prikaziMojeRadove() {
        ...
        try {
            ...
            String upit =   "SELECT * FROM rad " +
                            ...
                            "WHERE rad.status = 'PRIHVACEN' " +
                            "ORDER BY rad.datum ASC ;";
...
//                         + "ON konf_rad_autor.radID =rad.radID     ";
            ...
            while (rs.next()) {
               ...
               rad = new Rad(radID, naslov, kljucnereci, apstrakt, oblast, fileurl,status,listaautora,datum,konfID,korisnikID,knaziv);
